...
function Hero() {
  ...
  const fullText = 'Junior Backend Developer'
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-2 mb-8 animate-fade-in">
            ...
            <span className="text-text-muted font-mono text-sm">
              Estudiante DAM · Buscando prácticas
            </span>
          </div>
          ...
          <p className="text-text-secondary text-lg md:text-xl leading-relaxed mb-10 max-w-2xl animate-fade-in animate-delay-300">
            Desarrollo aplicaciones orientadas a datos y APIs con{' '}
            <span className="text-text-primary font-medium">Java</span>,{' '}
            <span className="text-text-primary font-medium">Spring Boot</span> y{' '}
